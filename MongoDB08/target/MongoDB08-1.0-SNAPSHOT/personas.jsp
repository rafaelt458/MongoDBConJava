                        ...
                        <tbody class="table-group-divider">
                            <c:forEach var="persona" items="${lista_personas}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="personas?accion=editar&codigo=${persona.id}" class="btn btn-outline-success">
                                            <span class="bi bi-arrow-left"></span>Editar
                                        </a>
                                        <a href="personas?accion=eliminar&codigo=${persona.id}" class="btn btn-outline-warning">
